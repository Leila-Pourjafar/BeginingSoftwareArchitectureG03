...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Amenities.Entities.Amenity", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Bookings.Entities.Booking", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Homes.Entities.Home", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Users.Entities.User", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Bookings.Entities.Booking", b =>
                {
                    b.HasOne("HouseRent.Core.Domain.Homes.Entities.Home", null)
                        .WithMany()
                        .HasForeignKey("HomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HouseRent.Core.Domain.Users.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("HouseRent.Core.Domain.Bookings.ValueObjects.DateRange", "Duration", b1 =>
                        {
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Homes.Entities.Home", b =>
                {
                    b.OwnsOne("HouseRent.Core.Domain.Homes.ValueObjects.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Homes.HomeAmenity", b =>
                {
                    b.HasOne("HouseRent.Core.Domain.Amenities.Entities.Amenity", "Amenity")
                        .WithMany()
                        .HasForeignKey("AmenityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HouseRent.Core.Domain.Homes.Entities.Home", "Home")
            ...
            modelBuilder.Entity("HouseRent.Core.Domain.Reviews.Review", b =>
                {
                    b.HasOne("HouseRent.Core.Domain.Bookings.Entities.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
